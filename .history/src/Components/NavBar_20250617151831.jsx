...
export default function Navbar() {
  ...
  return (
    <nav className="navbar shadow-md sticky top-0 z-50 backdrop-blur-md bg-white bg-opacity-90 transition-all duration-300">
      {/* Logo */}
            ...
            >
              {link.dropdown ? (
                <>
                  ...
                  {dropdownOpen === index && (
                    <ul className="absolute top-full left-0 mt-1 bg-white shadow-lg rounded-box p-2 w-48 z-50 transition-opacity duration-200 animate-fade-in">
      ...
      <div className="navbar-end">
        ...
        <div className="md:hidden relative">
          ...
          {/* Mobile Dropdown */}
          <ul
            className={`absolute right-0 mt-2 p-3 w-60 bg-white rounded-box shadow-lg transform transition-all duration-300 ease-in-out origin-top-right z-50
