...
export default function FeaturesSection() {
  return (
    <section className="relative py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6 bg-gradient-to-br from-gray-900 via-gray-950 to-indigo-950 min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={feature.title}
              className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-white/20 hover:border-indigo-400/50 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/20"
