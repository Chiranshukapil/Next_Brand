...
const plans = [
  {
    ...
    monthly: 9,
    yearly: 90,
    features: ["Unlimited Projects", "Up to 3 Team Members", "5 GB Cloud Storage", "Basic Integrations (Google Drive, Slack)",
        "Version History (7 days)", "Single Workspace", "Standard Security (SSL Encryption)"
    ],
    recommended: false,
  },
  {
    ...
    monthly: 19,
    yearly: 190,
    features: ["Everything in Basic", "Up to 15 Team Members", "100 GB Cloud Storage", "Advanced Integrations (Zapier, GitHub, Notion)", 
        "Priority Email & Chat Support", "Version History (30 days)", "Multiple Workspaces"],
    recommended: true,
  },
  {
    name: "Enterprise",
    ...
    monthly: null,
    yearly: null,
    features: ["Everything in Pro", "Unlimited Team Members", "1 TB+ Cloud Storage", "Custom Integrations & API", "24/7 Priority Support", "Advanced Security (SOC2, SAML, Audit Logs)", 
        "Custom SLAs"],
    recommended: false,
    contact: true,
  },
...
export default function PricingSection() {
  ...
  return (
    <section className="relative py-20 px-4 md:px-0 bg-gradient-to-br gap-879 from-gray-900 via-gray-950 to-indigo-950 min-h-[100vh]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-12 gap-2">
          <button
            className={`px-6 py-2 rounded-l-lg font-semibold transition-colors duration-200 hover:cursor-pointer border border-indigo-600 focus:outline-none ${
              billing === "monthly"
          ...
          <button
            className={`px-6 py-2 rounded-r-lg font-semibold transition-colors duration-200 hover:cursor-pointer border border-indigo-600 focus:outline-none ${
              billing === "yearly"
                ? "bg-indigo-600 text-white shadow"
                : "bg-gray-900 text-indigo-200 hover:bg-indigo-700/20"
            }`}
        ...
        <div className="grid md:grid-cols-3 gap-8 items-stretch">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <button
                className={`py-3 px-6 rounded-xl font-semibold text-lg transition-all hover:cursor-pointer duration-200 shadow-md focus:outline-none ${
                  plan.recommended
