...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gradient-to-br from-gray-900  to-indigo-950 backdrop-blur-md bg-opacity-80 shadow-lg flex justify-between items-center px-6 py-3">
      {/* Brand/Logo */}
