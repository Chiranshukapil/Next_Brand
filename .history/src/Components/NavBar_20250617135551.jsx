...
export default function Navbar() {
  ...
  return (
    <nav className="navbar bg-white shadow-md sticky top-0 z-50 backdrop-blur-md bg-opacity-90 border-b border-gray-200 transition-all duration-300">
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown lg:hidden">
          ...
          <ul
            tabIndex={0}
            className={`menu menu-sm dropdown-content mt-3 p-2 shadow-lg bg-white rounded-box w-56 transition-all duration-300 ease-in-out ${
              menuOpen
          ...
          >
            {navLinks.map((link) => (
              <li key={link.name}>
                {link.dropdown ? (
                  <details>
                    <summary className="text-base cursor-pointer flex items-center justify-between">
        ...
        {/* Logo */}
        <a className="btn btn-ghost text-xl font-bold tracking-tight flex items-center gap-2">
          <span className="inline-block w-8 h-8 bg-indigo-600 rounded-full text-white flex items-center justify-center font-bold">
            N
          </span>
          <span>NextBrand</span>
        </a>
