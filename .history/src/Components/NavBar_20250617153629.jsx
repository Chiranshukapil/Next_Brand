...
export default function Navbar() {
  ...
  return (
    <>
      <nav className=" shadow-md sticky top-0 z-50 backdrop-blur-md bg-opacity-90 transition-all duration-300">
        {/* Start: Logo */}
        ...
        <div className="navbar-end">
          ...
          <div className="dropdown md:hidden">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-sm dropdown-content mt-3 p-2 shadow-lg bg-white rounded-box w-56 right-0 left-auto transition-all duration-300 ease-in-out ${
                menuOpen
            ...
            >
              {navLinks.map((link) => (
                <li key={link.name}>
                  {link.dropdown ? (
                    <details>
                      {/* Only native chevron, no ChevronDown icon here */}
