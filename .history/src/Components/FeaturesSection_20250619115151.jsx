...
export default function FeaturesSection() {
  return (
    <section className=" py-16 px-6 bg-gradient-to-br from-gray-900 via-gray-950 to-indigo-950 min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <motion.button
            className="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:cursor-pointer hover:shadow-indigo-500/50 transition-all duration-300"
