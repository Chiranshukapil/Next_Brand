              ...
              >
                {link.dropdown ? (
                  <>
                    ...
                    {dropdownOpen === index && (
                      <ul className="absolute top-full left-0 mt-1 bg-gray-400 shadow-lg rounded-box p-2 w-48 z-50 animate-fade-in">
                        {link.dropdown.map((item) => (
                          <li key={item.name}>
                            <a
                              href={item.href}
                  ...
                  <a
                    href={link.href}
                    className="text-base font-medium text-white/80 hover:text-indigo-600 transition-colors"
                  >
                    {link.name}
                  </a>
                )}
