...
export default function PricingSection() {
  ...
  return (
    <section className="relative p px-4 md:px-0 bg-gradient-to-br from-gray-900 via-gray-950 to-indigo-950 min-h-[100vh]">
      
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[700px] rounded-full bg-indigo-800 opacity-10 blur-3xl pointer-events-none"></div>
