    ...
    <section className="relative py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-gray-900 via-gray-950 to-indigo-950 min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <motion.a
            href="/get-started"
            className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-4 pb-10 rounded-xl shadow-lg transition"
        ...
        <motion.div 
          className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 hover:cursor-pointer gap-4 sm:gap-6 md:gap-8 w-full"
