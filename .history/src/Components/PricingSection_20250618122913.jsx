...
export default function PricingSection() {
  ...
  return (
    <section className="relative py-8 px-1 sm:px-2 md:py-16 md:px-0 bg-gradient-to-br from-gray-900 via-gray-950 to-indigo-950 min-h-[100vh]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {/* Billing toggle */}
        <div className="flex justify-center mb-4 sm:mb-6 md:mb-12 gap-2">
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 md:gap-8 items-stretch">
          {plans.map((plan) => (
            <div
              key={plan.name}
              className={`relative flex flex-col p-3 sm:p-4 md:p-8 rounded-2xl md:rounded-3xl border transition-transform duration-200 bg-white/90 shadow-xl hover:scale-[1.03] w-full max-w-xs sm:max-w-md mx-auto h-full ${
                plan.recommended
            ...
            >
              {plan.recommended && (
                <span className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] sm:text-xs px-3 sm:px-4 py-1 rounded-full font-semibold shadow-lg z-30">
                  Recommended
                </span>
              )}
