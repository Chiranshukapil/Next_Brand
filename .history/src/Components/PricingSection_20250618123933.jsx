      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 items-stretch">
          {plans.map((plan) => (
            ...
            >
              {plan.recommended && (
                <span className="absolute -top-5 sm:-top-4 left-1/2 -translate-x-1/2 bg-indigo-600 text-white text-[10px] sm:text-xs px-3 sm:px-4 py-1 rounded-full font-semibold shadow-lg z-30">
                  Recommended
                </span>
              )}
